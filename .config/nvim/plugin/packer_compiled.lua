...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-path", "cmp_luasnip", "LuaSnip", "nvim-autopairs", "cmp-buffer" },
    loaded = false,
    needs_bufread = false,
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'fzf', 'nvim-lspconfig', 'nvim-treesitter'}, { event = "VimEnter *" }, _G.packer_plugins)]]
