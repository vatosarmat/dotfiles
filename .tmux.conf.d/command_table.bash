...
bind_command 'M-C-h' 'display-panes "move-pane -fbh -t %%"'
bind_command 'M-C-j' 'display-panes "move-pane -fv -t %%"'
bind_command 'M-C-k' 'display-panes "move-pane -fbv -t %%"'
bind_command 'M-C-l' 'display-panes "move-pane -fh -t %%"'
